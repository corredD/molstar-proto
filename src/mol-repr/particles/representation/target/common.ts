...
export function createTargetVisual(targetId: number, materialId: number, webgl?: WebGLContext): TargetVisual {
    ...
    let currentScaleByRadius = false;
    ...
    async function createOrUpdate(ctx: VisualContext, theme: Theme, props: ParticleTargetRepresentationProps, particles: ParticleList, particleIndices: OrderedSet<number>, target: ParticleTarget, filtered: ParticleList): Promise<void> {
        ...
        currentScaleByRadius = scaleByRadius;
    }
    ...
    function updateTransforms(particles: ParticleList) {
        ...
        createFilteredParticleTransform(filtered, geometry.boundingSphere, currentProps.cellSize, currentProps.batchSize, currentScaleByRadius, renderObject.values as unknown as TransformData);
        currentFiltered = filtered;
    }
